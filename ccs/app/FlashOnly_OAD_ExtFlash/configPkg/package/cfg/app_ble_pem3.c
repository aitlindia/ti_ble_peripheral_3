 ...
 */
xdc__META(__ASM__, "@(#)__ASM__ = C:/ti/simplelink/ble_sdk_2_02_01_18/examples/cc2650lp/simple_peripheral/ccs/app/FlashOnly_OAD_ExtFlash/configPkg/package/cfg/app_ble_pem3");
